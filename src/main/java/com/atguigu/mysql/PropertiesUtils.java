...
//            kafka配置
            ...
            kafkaConsumerKeyDeserializer = prop.getProperty("kafka.consumer.key.deserializer");
            kafkaConsumerValueDeserializer = prop.getProperty("kafka.consumer.value.deserializer");
        } catch (Exception e) {
